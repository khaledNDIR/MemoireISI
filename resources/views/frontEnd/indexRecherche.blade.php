...
<body>
        ...
        <div class="container">
            <div class="row fullscreen align-items-center justify-content-between">
                <div class="col-lg-6 col-md-6 banner-left">
                    ...
                    <h1 class="text-white">WEST|voyages</h1>
                    <p class="text-white">
    ...
    <!-- Start price Area -->
    <section class="price-area section-gap" style="margin-top: -15% ; border-radius: 5px;">
        <div class="container">
                                ...
                                <tbody>
                                    @foreach ($vols as $vol)
                                        <tr>
                                            ...
                                            <td>${{ $vol->prix }}</td>
                                            <td>
                                                <a href="{{ route('vols.reserver',['id' => $vol->id]) }}" class="btn btn-primary">Réserver</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
